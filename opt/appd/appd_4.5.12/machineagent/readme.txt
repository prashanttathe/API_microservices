****************************************************************************
   ...
   Please consult the documentation online for up-to-date information
       ...
       https://docs.appdynamics.com/display/4.5.12/Server+Monitoring
...
To enable HTTPS between the agent and the controller, consult the online documentation
        ...
        https://docs.appdynamics.com/display/4.5.12/Enable+SSL+for+Standalone+Machine+Agent
...
2. Depending on the downloaded package, the machine agent may or may not ship with a JRE (you can
   ...
   requires JRE version 1.8 and above.
...
bundled JRE? If not, is the JRE version you are using 1.8 or above? You can check by
...
More issues are discussed online here:
        ...
        https://docs.appdynamics.com/display/4.5.12/Standalone+Machine+Agent+FAQ
